...
/**
 * Read Agy's live per-conversation transcript and normalize tool activity for Workers.
 */
export async function readAgyTranscriptRecords(
   ...
   for (const line of text.split(/\r?\n/)) {
      ...
      try {
         ...
         // Agy may be appending the final JSONL line while Pi Workers reads it. Retry on the next poll.
      }
   }
