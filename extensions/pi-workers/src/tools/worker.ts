...
export const WorkerListToolParamsSchema = Type.Object({}, { description: "List worker jobs." });
...
export interface HandleWorkerSpawnOptions {
   ...
   readonly inheritedModel?: InheritedModelInfo;
   readonly cwd?: string;
...
export const handleWorkerCancel = Effect.fn("worker.handleCancel")(function* (params: WorkerCancelToolParams) {
   ...
   return { ok: false, error: `Worker job "${params.id}" not found.` };
});
