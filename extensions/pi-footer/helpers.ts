...
import type { CustomStatusItem, SegmentContext, StatusLinePreset, StatusLineSegmentId } from "./types.js";
...
export function buildContentFromParts(parts: string[], presetDef: ReturnType<typeof getPreset>): string {
