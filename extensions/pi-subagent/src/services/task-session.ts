...
export interface ParentSessionGateShape {
  ...
  ) => Effect.Effect<void, ParentSessionActivationError>;
  ...
  static readonly layer = Layer.effect(
    ...
    Effect.sync(() => {
      ...
      let state:
        ...
        | { readonly status: "failed"; readonly error: ParentSessionActivationError } = {
        status: "ready",
      };
      ...
      const markFailed = Effect.fn("ParentSessionGate.markFailed")(
        function* (error, parentSessionFile) {
