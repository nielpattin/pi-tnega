...
export const WebResearchToolParamsSchema = Type.Object(
  {
    ...
    queries: Type.Optional(
      Type.Array(Type.String(), {
        description:
          "Optional list of 2-4 varied query angles searched in parallel for multi-perspective research.",
      }),
    ),
    scope: Type.Optional(
    ...
    authors: Type.Optional(
      Type.String({
        description:
          "Author substring filter for academic paper search (e.g. 'Vaswani', 'Dhariwal').",
      }),
    ),
    ...
    includeDomains: Type.Optional(
      Type.Array(Type.String(), {
        description:
          "Optional list of domains or paths to focus research on (e.g. ['docs.rs', 'github.com']).",
      }),
    ),
...
export async function handleWebResearch(
  ...
  return { content: [{ type: "text", text: formattedText }], details: response };
}
