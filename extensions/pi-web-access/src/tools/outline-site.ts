...
export const OutlineSiteToolParamsSchema = Type.Object(
  {
    ...
    include_subdomains: Type.Optional(
      Type.Boolean({ description: "Whether to discover URLs on subdomains. Defaults to true." }),
    ),
  },
  {
    description:
...
export const outlineSiteTool: ToolDefinition<
  typeof OutlineSiteToolParamsSchema,
  SiteOutlineResponse
> = {
  name: "outline_site",
  label: "Outline Site",
