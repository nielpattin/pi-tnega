...
async function generateShowcasePdf() {
  ...
  page1.drawText(
    "This document is specifically crafted to exercise the layout engine of Firecrawl's pdf-inspector.",
    { x: 50, y, size: 10, font: fontRegular, color: rgb(0.2, 0.2, 0.2) },
  );
  y -= 15;
  ...
  // Row 1
  page1.drawText("pdf-inspector (Rust)", {
    x: col1 + 10,
    y: tableTop - 15 - rowHeight,
    size: 9,
    font: fontRegular,
  });
  page1.drawText("0.915", {
    x: col2 + 10,
    y: tableTop - 15 - rowHeight,
    size: 9,
    font: fontRegular,
  });
  page1.drawText("0.814", {
    x: col3 + 10,
    y: tableTop - 15 - rowHeight,
    size: 9,
    font: fontRegular,
  });
  page1.drawText("0.470s", {
    x: col4 + 10,
    y: tableTop - 15 - rowHeight,
    size: 9,
    font: fontRegular,
  ...
  // Row 2
  page1.drawText("LiteParse", {
    x: col1 + 10,
    y: tableTop - 15 - rowHeight * 2,
    size: 9,
    font: fontRegular,
  });
  page1.drawText("0.913", {
    x: col2 + 10,
    y: tableTop - 15 - rowHeight * 2,
    size: 9,
    font: fontRegular,
  });
  page1.drawText("0.693", {
    x: col3 + 10,
    y: tableTop - 15 - rowHeight * 2,
    size: 9,
    font: fontRegular,
  });
  page1.drawText("0.750s", {
    x: col4 + 10,
    y: tableTop - 15 - rowHeight * 2,
    size: 9,
    font: fontRegular,
  ...
  // Row 3
  page1.drawText("PyMuPDF4LLM", {
    x: col1 + 10,
    y: tableTop - 15 - rowHeight * 3,
    size: 9,
    font: fontRegular,
  });
  page1.drawText("0.886", {
    x: col2 + 10,
    y: tableTop - 15 - rowHeight * 3,
    size: 9,
    font: fontRegular,
  });
  page1.drawText("0.401", {
    x: col3 + 10,
    y: tableTop - 15 - rowHeight * 3,
    size: 9,
    font: fontRegular,
  });
  page1.drawText("17.117s", {
    x: col4 + 10,
    y: tableTop - 15 - rowHeight * 3,
    size: 9,
    font: fontRegular,
  ...
  page2.drawText("The parser detects multi-column", {
    x: colLeftX,
    y: y2 - 14,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("layouts by projecting vertical", {
    x: colLeftX,
    y: y2 - 28,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("gutters across text items.", {
    x: colLeftX,
    y: y2 - 42,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("Lines within each column are", {
    x: colLeftX,
    y: y2 - 56,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("grouped sequentially before", {
    x: colLeftX,
    y: y2 - 70,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("advancing to the next column.", {
    x: colLeftX,
    y: y2 - 84,
    size: 9,
    font: fontRegular,
  ...
  page2.drawText("This ensures newspaper-style and", {
    x: colRightX,
    y: y2 - 14,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("academic paper columns are read", {
    x: colRightX,
    y: y2 - 28,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("top-to-bottom per column rather", {
    x: colRightX,
    y: y2 - 42,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("than interleaved horizontally.", {
    x: colRightX,
    y: y2 - 56,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("Full ToUnicode CMaps resolve all", {
    x: colRightX,
    y: y2 - 70,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("custom glyph identifiers.", {
    x: colRightX,
    y: y2 - 84,
    size: 9,
    font: fontRegular,
  ...
  page2.drawText("Cloud Compute", {
    x: fCol1 + 10,
    y: finTop - 15 - rowHeight,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("$1,245.50", {
    x: fCol2 + 10,
    y: finTop - 15 - rowHeight,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("$1,480.20", {
    x: fCol3 + 10,
    y: finTop - 15 - rowHeight,
    size: 9,
    font: fontRegular,
  ...
  page2.drawText("$820.10", {
    x: fCol2 + 10,
    y: finTop - 15 - rowHeight * 2,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("$1,095.40", {
    x: fCol3 + 10,
    y: finTop - 15 - rowHeight * 2,
    size: 9,
    font: fontRegular,
  ...
  page2.drawText("AI Agent Workflows", {
    x: fCol1 + 10,
    y: finTop - 15 - rowHeight * 3,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("$450.00", {
    x: fCol2 + 10,
    y: finTop - 15 - rowHeight * 3,
    size: 9,
    font: fontRegular,
  });
  page2.drawText("$710.80", {
    x: fCol3 + 10,
    y: finTop - 15 - rowHeight * 3,
    size: 9,
    font: fontRegular,
