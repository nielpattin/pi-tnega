...
export type RaftToolShellDecorator = <TTool extends AnyTool>(
  tool: TTool,
  options?: {
...
export const withCodePreviewShell: RaftToolShellDecorator = (tool, options = {}) => {
  ...
  const renderResult = (
    ...
    originalRenderResult
      ? originalRenderResult.call(
          tool,
          result as never,
          resultOptions as never,
          theme,
          context as never,
        )
      : new Container();
