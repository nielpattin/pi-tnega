/** Tracks rendered raft_exec cards so a display preference switch redraws the current transcript. */
export class RaftToolDisplayController {
  readonly #invalidators = new Map<string, { call?: () => void; result?: () => void }>();
