...
type ChangedLinePairCandidate = { removedPosition: number; addedPosition: number; score: number };
...
type ChangedLinePositions = { removed: Map<number, number>; added: Map<number, number> };
