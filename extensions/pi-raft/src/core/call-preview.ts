...
// of a nested Raft call — the value shown beside a tool's name in the chat
// preview (e.g. `recall <query>`) and appended to its ref in the dashboard
// (e.g. `extensions.vcc_recall · <query>`). Core tools and first-class
// Raft providers (agents/mcp management) keep their bespoke, tuned
// previews; this picks up everything else — extension tools and
