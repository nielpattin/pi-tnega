...
export const buildSkillReferenceGuidance = (
  ...
  return [
    ...
    mappings,
    "Load each mapped SKILL.md through pi.read inside raft_exec and follow it. Skill loading is a dependency, not task exploration. Continue the active workflow after tool results and later user replies until it completes.",
  ].join("\n");
};
