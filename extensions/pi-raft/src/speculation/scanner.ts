...
// Root namespaces the model can call from a raft program. Calls are emitted
...
export class LiteralCallScanner {
  ...
  push(code: string): RaftSpeculationCandidate[] {
    ...
    const candidates: RaftSpeculationCandidate[] = [];
  ...
  // raft calling convention. Positional multi-arg calls are skipped: their
