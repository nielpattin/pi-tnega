import type { RaftRunDisplay } from "./activity/types.js";

// Silent repair for raft_exec `display` near-misses. The declared shape is
...
// flat-tool-schema note in raft-exec-tool.ts.

const recordDisplay = (record: Record<string, unknown>): RaftRunDisplay | undefined => {
  const display: RaftRunDisplay = {};
...
export const normalizeRunDisplay = (input: unknown): RaftRunDisplay | undefined => {
