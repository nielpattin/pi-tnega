...
// from pi-raft's own module graph and hands createHighlighter the *object*,
...
import { configureHighlighting, highlightCode, initHighlighting } from "../src/ui/highlight.js";
...
beforeEach(() => {
  ...
  createHighlighterMock.mockImplementation(
    async (options: { themes: unknown[]; langs: unknown[] }) => {
...
describe("shiki host-loader theme resolution (#46)", () => {
  ...
  it("resolves a bundled theme id to its object from pi-raft's module graph", async () => {
