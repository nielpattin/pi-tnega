...
import { buildSkillReferenceGuidance, type SkillReference } from "../src/core/skill-references.js";

const skills: SkillReference[] = [
  { name: "grill-me", filePath: "/skills/grill-me/SKILL.md", disableModelInvocation: true },
  { name: "grilling", filePath: "/skills/grilling/SKILL.md" },
  { name: "research", filePath: "/skills/research/SKILL.md" },
  { name: "private-flow", filePath: "/skills/private-flow/SKILL.md", disableModelInvocation: true },
];
...
describe("skill reference guidance", () => {
  ...
  it("ignores negated and non-invocation references", () => {
    expect(
      buildSkillReferenceGuidance(expandedPrompt("Do not use `/research`."), skills),
    ).toBeUndefined();
    expect(
      buildSkillReferenceGuidance(expandedPrompt("The related skill is `/research`."), skills),
    ).toBeUndefined();
    expect(
