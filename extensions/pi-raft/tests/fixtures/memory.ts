...
// pi-ai (which is not a direct dependency of pi-raft). The shapes below are
...
): FixtureEntry => ({ type: "session", version: 3, id, parentId: null, timestamp, cwd });
...
export const writeSessionFile = (dir: string, name: string, entries: FixtureEntry[]): string => {
