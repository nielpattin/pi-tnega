...
Pi local setup note: this machine has a Git Bash wrapper at `C:/Users/niel/.local/bin/drawio` and `drawio.cmd`, both pointing to `C:/Program Files/draw.io/draw.io.exe`. Prefer `drawio` in bash commands.
