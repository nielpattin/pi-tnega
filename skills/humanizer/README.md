...
A skill for Pi that removes signs of AI-generated writing from text, making it sound more natural and human.
...
Clone directly into Pi's skills directory:

```bash
mkdir -p ~/.config/pi/agent/skills
git clone https://github.com/blader/humanizer.git ~/.config/pi/agent/skills/humanizer
```
